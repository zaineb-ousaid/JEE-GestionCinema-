...
public class CinemaInitServiceImpl implements ICinemaInitService {
	...
	public void initCategories() {
		Stream.of("Histoire","Actions","Fiction","Drama","Horror","Comedy").forEach(cat->{
	...
	public void initFilms() {
		double[] durees=new double[] {1,1.5,2,2.5,3,2,2,2,2,2};
		List<Categorie> categories=categorieRepository.findAll();
		Stream.of("Conjuring","Jojo Rabbit","Jocker","Batman","Spider Man",
                "Gangster Squad","Gemini Man","The Boy","The Upside","Baby Driver").forEach(titreFilm->{
		Film film=new Film();
